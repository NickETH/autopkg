...
* importing these into a software distribution system like Munki, Jamf Pro, Intune or SCCM, Baramundi on Windows etc.
...
An Installation-Script for everything need can be found here: https://github.com/NickETH/autopkg-win-scripts
